        ...
        <div class="shadow-md w-2/5 rounded-xl bg-white bg-opacity-90 p-8">
            ...
            <div v-else>
                ...
                <form @submit.prevent="onResetPassword">
                    ...
                    <div class="mb-4">
                        <label for="password" class="mb-1 block font-semibold text-lg text-gray-700">New Password</label>
                        <input v-model="newPassword" type="password" name="password" required class="w-full p-2 border border-gray-300 text-lg text-gray-600" />
                    </div>

                    <button class="h-10 w-44 bg-[color:var(--p-blue-md)] text-lg text-white font-semibold rounded-md flex items-center justify-center">
                        <svg
                            v-if="loading"
                            aria-hidden="true"
                            class="w-6 h-6 mr-2 text-white animate-spin fill-[color:var(--p-blue-md)]"
