...
const heading = ref([
    ...
    'Skip the Commute, Work from Anywhere'
])
const description = ref('Flex Job listings is a curated job board of the best remote jobs for any industry.')

</script>  
<template>
    <div class="bg-[color:var(--p-blue-drk)] text-white hero">
        <div class="max-w-screen-md mx-auto text-center px-10 py-32">
...
.hero {
    ...
    /* background-image: url(../assets/MassCircles.svg);
    background-image: url(../assets/ShinyOverlay.svg);
    background-image: url(../assets/RectLight.svg);
